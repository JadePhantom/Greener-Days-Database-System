...
def add_record():
    ...
    if choice == '1':  
        ...
        try:
            ...
            if "UNIQUE constraint failed: Customer_ID" in str(e):
                print("Customer ID must be unique. The value you entered already exists.")
            elif "UNIQUE constraint failed: Customer_Phone" in str(e):
                print("Customer phone number must be unique. The value you entered already exists.")
            elif "UNIQUE constraint failed: Email" in str(e):
                print("Customer email must be unique. The value you entered already exists.")
            elif "CHECK constraint failed: Customer_ID" in str(e):
                print("Customer ID must start with 'C' followed by 5 digits (e.g., C12345).")
            elif "CHECK constraint failed: Customer_First_Name" in str(e):
                print("First Name must contain only letters.")
            elif "CHECK constraint failed: Customer_Last_Name" in str(e):
                print("Last Name must contain only letters.")
            elif "CHECK constraint failed: Birth_Date" in str(e):
                print("Birth Date must be in DD/MM/YYYY format. (e.g., 04/05/2008)")
            elif "CHECK constraint failed: Customer_Phone" in str(e):
                print("Phone must start with '04' and be followed by 8 digits (e.g., 0405200867).")
            elif "CHECK constraint failed: Email" in str(e):
        ...
        try:
            ...
            if "UNIQUE constraint failed: Booking_ID" in str(e):
                print("Booking ID must be unique. The value you entered already exists.")
            elif "UNIQUE constraint failed: Booking_Date, Customer_ID" in str(e):
                print("Booking Date and Customer ID must be unique. A customer cannot have two bookings on the same date.")
            elif "CHECK constraint failed: Booking_ID" in str(e):
                print("Booking ID must start with 'B' followed by 5 digits (e.g., B12345).")
            elif "CHECK constraint failed: Booking_Date" in str(e):
                print("Booking Date must be in DD/MM/YYYY format. (e.g., 04/05/2008)")
            elif "CHECK constraint failed: Total_Cost" in str(e):
                print("Total Cost must be a number to 2 decimal places. (e.g., 100.00)")
            elif "CHECK constraint failed: Total_Duration" in str(e):
        ...
        try:
            ...
            if "UNIQUE constraint failed" in str(e):
                print("Service ID must be unique. The value you entered already exists.")
            elif "UNIQUE constraint failed: Service_Type" in str(e):
                print("Service Type must be unique. The value you entered already exists.")
            elif "CHECK constraint failed: Service_ID" in str(e):
                print("Service ID must start with 'S' followed by 5 digits (e.g., S12345).")
            elif "CHECK constraint failed: Service_Type" in str(e):
                print("Service Type must contain only letters and spaces.")
            elif "CHECK constraint failed: Service_Cost" in str(e):
                print("Service Cost must be a number to 2 decimal places. (e.g., 100.00)")
            elif "CHECK constraint failed: Service_Duration" in str(e):
        ...
        try:
            ...
            if "UNIQUE constraint failed: Employee_ID" in str(e):
                print("Employee ID must be unique.")
            elif "UNIQUE constraint failed: Employee_Phone" in str(e):
                print("Employee phone number must be unique. The value you entered already exists.")
            elif "CHECK constraint failed: Employee_ID" in str(e):
                print("Employee ID must start with 'E' followed by 5 digits (e.g., E12345).")
            elif "CHECK constraint failed: Employee_First_Name" in str(e):
                print("First Name must contain only letters.")
            elif "CHECK constraint failed: Employee_Last_Name" in str(e):
                print("Last Name must contain only letters.")
            elif "CHECK constraint failed: Employee_Phone" in str(e):
                print("Phone must start with '04' and be followed by 8 digits. (e.g., 0405200867).")
            else:
                print(f"Database error: {e}")
        ...
        try:
            ...
            if "UNIQUE constraint failed: Payment_ID" in str(e):
                print("Payment ID must be unique. The value you entered already exists.")
            elif "UNIQUE constraint failed: Booking_ID, Payment_Method" in str(e):
                print("Booking ID and Payment Method must be unique. A booking cannot have two payments with the same method.")
            elif "CHECK constraint failed: Payment_ID" in str(e):
                print("Payment ID must start with 'P' followed by 5 digits (e.g., P12345).")
            elif "CHECK constraint failed: Payment_Method" in str(e):
                print("Payment Method must contain only letters and spaces.")
            elif "CHECK constraint failed: Payment_Completed" in str(e):
        ...
        try:
            ...
            if "UNIQUE constraint failed: Job_ID" in str(e):
                print("Job ID must be unique. The value you entered already exists.")
            elif "UNIQUE constraint failed: Job_Date, Service_ID, Employee_ID" in str(e):
                print("Job Date, Service ID, and Employee ID must be unique. A job cannot be scheduled for the same service and employee on the same date.")
            elif "CHECK constraint failed: Job_ID" in str(e):
                print("Job ID must start with 'J' followed by 5 digits (e.g., J12345).")
            elif "CHECK constraint failed: Job_Date" in str(e):
                print("Job Date must be in DD/MM/YYYY format. (e.g., 04/05/2008).")
            elif "CHECK constraint failed: Job_Completed" in str(e):
                print("Job Completed must be True or False.")
            elif "FOREIGN KEY constraint failed: Service_ID" in str(e):
                print("Service ID does not exist. Please enter valid .")
            elif "FOREIGN KEY constraint failed: Employee_ID" in str(e):
                print("Employee ID does not exist. Please enter valid ID.")
            else:
                print(f"Database error: {e}")
    ...
    if choice == '1':  
        ...
        try:
            ...
            if "UNIQUE constraint failed: Job_ID" in str(e):
                ...
                print("Service ID does not exist. Please enter valid ID.")
            elif "FOREIGN KEY constraint failed: Employee_ID" in str(e):
                print("Employee ID does not exist. Please enter valid ID.")
            else:
                print(f"Database error: {e}")
