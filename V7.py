    ...
    if choice == '1':  
        ...
        try:
            ...
            if "FOREIGN KEY constraint failed" in str(e):
                print("Cannot delete customer. There are related bookings, payments, or jobs.")
            else:
                print(f"Database error: {e}")
        ...
        try:
            ...
            if "FOREIGN KEY constraint failed" in str(e):
                print("Cannot delete booking. There are related services or payments.")
            else:
                print(f"Database error: {e}")
        ...
        try:
            ...
            if "FOREIGN KEY constraint failed" in str(e):
                print("Cannot delete service. There are related jobs.")
            else:
                print(f"Database error: {e}")
        ...
        try:
            ...
            if "FOREIGN KEY constraint failed" in str(e):
                print("Cannot delete employee. There are related jobs.")
            else:
                print(f"Database error: {e}")
